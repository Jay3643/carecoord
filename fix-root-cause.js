// fix-root-cause.js
// Fixes database.js wrapper to auto-convert ALL Uint8Array values to strings
// This means NO other file needs toStr() or sanitize() — it just works.
...
console.log('✓ database.js — ALL query results now auto-convert Uint8Array to strings');
console.log('  No other file needs toStr() or sanitize() for db results anymore');
console.log('');
console.log('Server will auto-restart. Refresh browser.');
