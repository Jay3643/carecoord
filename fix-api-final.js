...
// Remove any trailing undefined lines
api = api.replace(/\nundefined\n/g, '\n').replace(/\nundefined$/g, '');
...
api = api.replace(
  ...
  "  adminDeleteRegion: (id) => request(`/admin/regions/${id}`, { method: 'DELETE' })," + workspaceMethods + "\n};"
);

fs.writeFileSync(apiPath, api, 'utf8');
console.log('✓ api.js — workspace methods inserted');
