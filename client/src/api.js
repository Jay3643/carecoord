...
export const api = {
  ...
  sendReplyAll: (id, body, attachments) => request('/tickets/' + id + '/reply-all', { method: 'POST', body: { body, attachments } }),
  forwardTicket: (id, toEmail, body, attachments) => request('/tickets/' + id + '/forward', { method: 'POST', body: { toEmail, body, attachments } }),
