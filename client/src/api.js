...
export const api = {
  ...
  updateAway: (away) => request('/auth/me/away', { method: 'PUT', body: away }),
  adminUpdateClosure: (regionId, closure) => request('/admin/regions/' + regionId + '/closure', { method: 'PUT', body: closure }),
